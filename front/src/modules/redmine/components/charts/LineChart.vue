...
type LineChartDatum = number | null | undefined;
...
const chartOption = computed<EChartsOption>(() => {
  ...
  const series: LineSeriesOption[] = props.series.map((entry) => ({
    name: entry.name,
    type: "line",
    ...
    areaStyle: entry.area || props.area || props.stacked ? {opacity: 0.18} : undefined,
...
<template>
  <div class="line-chart" :style="{height: containerHeight}">
    <div
      v-if="hasData"
      ref="chartContainer"
