...
class RedmineIssueAnalysisSqliteRepository extends AbstractSqliteRepository<IRedmineIssueAnalysis, IRedmineIssueAnalysisBase, IRedmineIssueAnalysisBase> implements IRedmineIssueAnalysisRepository {
    ...
    protected jsonFields: string[] = ['areasImpacto', 'senialesDesperdicio', 'senialesProceso'];
    ...
    protected tableFields: SqliteTableField[] = [
        {name: "redmineIssue", type: "TEXT", unique: true, primary: false},
...
{name: "confianza", type: "FLOAT", unique: undefined, primary: false},
{name: "confianza", type: "TEXT", unique: undefined, primary: false}
    ]
