...
const RedmineIssueAnalysisBaseSchema = z.object({
    ...
    moduloPropuesto: z.string().nullish(),
    ...
    calidadCriteriosAceptacion: z.enum(['muy_baja', 'baja', 'media', 'alta', 'muy_alta']).nullish(),
    atomicidad: z.enum(['muy_baja', 'baja', 'media', 'alta', 'muy_alta']).nullish(),
    ambiguedadDefinicion: z.enum(['muy_baja', 'baja', 'media', 'alta', 'muy_alta']).nullish(),
    claridadAlcance: z.enum(['muy_baja', 'baja', 'media', 'alta', 'muy_alta']).nullish(),
    testabilidad: z.enum(['muy_baja', 'baja', 'media', 'alta', 'muy_alta']).nullish(),
    consistencia: z.enum(['muy_baja', 'baja', 'media', 'alta', 'muy_alta']).nullish(),
    riesgoErrorQA: z.enum(['muy_bajo', 'bajo', 'medio', 'alto', 'muy_alto']).nullish(),
    requiereRefinamiento: z.boolean().nullish(),
    cantidadObjetivosDetectados: z.number().min(0).nullish(),
    ...
    observacionesDefinicion: z.string().nullish(),
});
